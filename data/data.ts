...
export const projects: IProjects[] = [
  {
    id: 1,
    name: "Book Store",
    description: "A modern Book-store app with React & TypeScript",
  ...
  },
  {
    ...
    name: "Coffee App",
    description:
      "☕Coffee shop mobile app built with React Native, Expo, and TypeScript. Features a clean UI, product listing, and quantity controls. Under active development.",
    href: "",
